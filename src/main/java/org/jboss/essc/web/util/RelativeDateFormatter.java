 ...
 * @since 1.0.3
 */
public class RelativeDateFormatter extends DateFormat {
     ...
     */
    public RelativeDateFormatter(Date time) {
        this(time.getTime());
    }
     ...
     */
    public RelativeDateFormatter(long baseMillis) {
        super();
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (!(obj instanceof RelativeDateFormatter))
            return false;
        if (!super.equals(obj))
            return false;
        RelativeDateFormatter that = (RelativeDateFormatter) obj;
     ...
     */
    public Object clone() {
        RelativeDateFormatter clone = (RelativeDateFormatter) super.clone();
    ...
    public static void main(String[] args) {
        ...
        RelativeDateFormatter rdf = new RelativeDateFormatter(c0.getTime().getTime());
